...
def scrape():
	...
	try:
		WebDriverWait(driver, 10).until(EC.presence_of_element_located((
			By.XPATH, '//*[@id="CybotCookiebotDialogBodyLevelButtonLevelOptinAllowallSelection"]'))).click()
	except:
		pass

	# Job openings
	WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.LINK_TEXT, 'View job openings'))).click()
