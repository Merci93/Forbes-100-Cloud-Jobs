	...
	if len(jobs) != 0:
		for job in jobs:
			try:
				...
				role = job.find('div', {'class':'job-title'}).text
				team = job.find('div', {'class':'department'}).text
