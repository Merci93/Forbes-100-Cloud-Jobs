...
def scrape():
	...
	# Open positions
	WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.LINK_TEXT, 'Explore All Jobs'))).click()

	search_body = bs(driver.page_source, 'lxml')
	jobs = search_body.find_all('div', {'class':'department'})
